...
func CreateRoutes(rUser *mw.UserGroup) {
	rUser.AddNamedRoute(router.Templates.List, "/templates/", templatesApi.TemplatesPage, http.MethodGet)
	...
	rUser.AddNamedRoute(router.Templates.Create, "/templates/", templatesApi.TemplateCreate, http.MethodPost)
