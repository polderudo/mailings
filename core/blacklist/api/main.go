...
func CreateRoutes(rUser *mw.UserGroup) {
	...
	// Einzelne Adresse manuell sperren (source=manual, reason=Manual).
	rUser.AddNamedRoute(router.Blacklist.Add, "/blacklist/add/", blacklistApi.BlacklistAdd, http.MethodPost)
