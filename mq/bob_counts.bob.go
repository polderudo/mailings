...
type preloadCounts struct {
	MailDomain   mailDomainCountPreloader
	MailList     mailListCountPreloader
	MailTemplate mailTemplateCountPreloader
	Mailing      mailingCountPreloader
	UserProfile  userProfileCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		MailDomain:   buildMailDomainCountPreloader(),
		MailList:     buildMailListCountPreloader(),
		MailTemplate: buildMailTemplateCountPreloader(),
		Mailing:      buildMailingCountPreloader(),
		UserProfile:  buildUserProfileCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	MailDomain   mailDomainCountThenLoader[Q]
	MailList     mailListCountThenLoader[Q]
	MailTemplate mailTemplateCountThenLoader[Q]
	Mailing      mailingCountThenLoader[Q]
	UserProfile  userProfileCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		MailDomain:   buildMailDomainCountThenLoader[Q](),
		MailList:     buildMailListCountThenLoader[Q](),
		MailTemplate: buildMailTemplateCountThenLoader[Q](),
		Mailing:      buildMailingCountThenLoader[Q](),
		UserProfile:  buildUserProfileCountThenLoader[Q](),
	}
}
